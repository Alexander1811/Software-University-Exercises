...
namespace P09_Miner
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ReadMatrix(matrix, ref minerRow, ref minerCol, ref coalsCount);
        ...
        private static void ReadMatrix(char[,] matrix, ref int minerRow, ref int minerCol, ref int coalsCount)
        {
