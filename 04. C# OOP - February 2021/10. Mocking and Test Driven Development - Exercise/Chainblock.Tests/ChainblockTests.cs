...
namespace Chainblock.Tests
{
    public class ChainblockTests
    {
        ...
        public void GetByTransactionStatus_ReturnsFilteredAndSortedData_WhenChainblockContainsTransactionsWithStatus()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.Status == filterStatus).OrderByDescending(t => t.Amount).ToList();
        ...
        public void GetAllSendersWithTransactionStatus_ReturnsFilteredAndSortedData_WhenChainblockContainsTransactionsWithStatus()
        {
            ...
            List<string> expectedSenders = this.chainblock.Where(t => t.Status == filterStatus).OrderByDescending(t => t.Amount).Select(t => t.From).ToList();
        ...
        public void GetAllReceiversWithTransactionStatus_ReturnsFilteredAndSortedData_WhenChainblockContainsTransactionsWithStatus()
        {
            ...
            List<string> expectedReceivers = this.chainblock.Where(t => t.Status == filterStatus).OrderByDescending(t => t.Amount).Select(t => t.To).ToList();
        ...
        public void GetAllOrderedByAmountDescendingThenById_ReturnsSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.OrderByDescending(t => t.Amount).ThenBy(t => t.Id).ToList();
        ...
        public void GetBySenderOrderedByAmountDescending_ReturnsFilteredAndSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.From == sender).OrderByDescending(t => t.Amount).ToList();
        ...
        public void GetByReceiverOrderedByAmountThenById_ReturnsFilteredAndSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.To == receiver).OrderByDescending(t => t.Amount).ThenByDescending(t => t.Id).ToList();
        ...
        public void GetByTransactionStatusAndMaximumAmount_ReturnsFilteredAndSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.Status == filterStatus && t.Amount <= filterAmount).OrderByDescending(t => t.Amount).ToList();
        ...
        public void GetBySenderAndMinimumAmountDescending_ReturnsFilteredAndSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.From == realSender && t.Amount > amountMin).OrderByDescending(t => t.Amount).ToList();
        ...
        public void GetByReceiverAndAmountRange_ReturnsFilteredAndSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.To == realReceiver && t.Amount >= lo && t.Amount < hi).OrderByDescending(t => t.Amount).ToList();
        ...
        public void GetAllInAmountRange_ReturnsFilteredAndSortedData()
        {
            ...
            List<ITransaction> expectedTransactions = this.chainblock.Where(t => t.Amount >= lo && t.Amount <= hi).OrderByDescending(t => t.Amount).ToList();
