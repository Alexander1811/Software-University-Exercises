...
public class BankVault
{
    ...
    public IReadOnlyDictionary<string, Item> VaultCells => this.vaultCells.ToImmutableDictionary();
    ...
    public string AddItem(string cell, Item item)
    {
        ...
        bool cellExists = this.vaultCells.Values.Any(x => x?.ItemId == item.ItemId);
